  ...
  <div>
    <div>
      ...
      >
        <div class="back">
          <!-- <img
            src="https://i.pinimg.com/736x/3c/e2/f6/3ce2f67e5ee7dc8f67f27adb6368f570.jpg"
          /> -->
        </div>
        <v-img
          contain
      ...
      <v-row class="text-center">
        ...
        <v-col cols="12" md="4">
          <svg
            ...
            x="0px"
            y="0px"
            viewBox="0 0 111.44 122.88"
            style="enable-background: new 0 0 111.44 122.88"
            xml:space="preserve"
          >
            <g>
              <path
        ...
        ><v-col cols="12">
          <v-card elevation="11" outlined shaped tile>
            ...
            >
              ...
              volunteers and local bodies into identifying & understanding the
              real world issues, to be able to find effective and efficient
              solutions by mutual understanding and collaboration. In 2018, the
              SIGHT program was conceptualized and launched under the IEEE AMU
              student branch, with the objective to expose undergraduate
              students to population realities and the corresponding issues
              faced by local communities. Students are thus encouraged to
              develop projects accounting as small steps to be a part of the
              larger picture and making the world a more sustainable place. We
              take pride in being a part of IEEE SIGHT and work for humanitarian
              needs through our teamwork, solidarity & commitment.
            </v-card-text>
          </v-card>
        </v-col></v-row
      >
...
.back {
  ...
  background-image: url(https://cdn.pixabay.com/photo/2015/10/12/15/27/light-bulb-984551_1280.jpg);
}
#sight_photo {
  margin-top: 1rem;
